...
if __name__ == '__main__':
    alias_optuna = "positive_rubricnet"
    sqlite_url = f'sqlite:///{alias_optuna}_basic.db'


    study = optuna.create_study(study_name=alias_optuna, directions=['maximize', 'minimize'], storage=sqlite_url, load_if_exists=True)
